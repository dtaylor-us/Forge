...
- `VerificationService`: coordinate deterministic checks, test commands, and
  verification artifacts. Test discovery and command execution helpers remain
  domain or infrastructure concerns.
